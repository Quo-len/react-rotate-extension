  ...
  return (
    <div>
      ...
      <div className="button-group">
        <button id="rotateLeft" onClick={() => sendCommand('left')} disabled={isDisabled}>
          <svg
            className="icon"
            stroke="currentColor"
            fill="none"
        ...
        <button id="rotateRight" onClick={() => sendCommand('right')} disabled={isDisabled}>
          <svg
            className="icon"
            stroke="currentColor"
            fill="none"
        ...
        <button id="reset" onClick={() => sendCommand('reset')} disabled={isDisabled}>
          <svg
            className="icon"
            stroke="currentColor"
            fill="currentColor"
      ...
      <div className="footer">Page Flip v4.2</div>
    </div>
  );
};
